...
public class UserAuthControl {
	...
	public ResponseEntity<String> loginInfo(
		...
		if (loginInfo != null) {
			List<Object> jsonResultList = new ArrayList<Object>();
//			jsonResultList.add(loginInfo);
	...
	public String login1(
		...
		if (loginInfo != null) {
			model.addAttribute("loginInfo", loginInfo);
			model.addAttribute("jsonResult", new JsonResult().setStatus("success"));
			//model.addAttribute("status", "success");
		} else {
			status.setComplete();
			model.addAttribute("jsonResult", new JsonResult().setStatus("fail"));
